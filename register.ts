 ...
 *
 *   bun run register            # or: PORT=7940 bun run register
 *
 ...
 * the id from the filename, so `roadmap.notes.json` is what makes this
 * `roadmap.notes`. Two files naming the same port under different names are two
