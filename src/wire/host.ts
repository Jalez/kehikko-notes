...
/**
 * The bridge, and nothing about notes.
 *
 ...
 * nothing about notes or anchors, and the code that knows about those knows
 ...
 * here would be notes drawn against another canvas's document.
 *
 ...
 * somebody is already reading — and the write ticket, which is the one secret
 * this page holds, never crosses the bridge at all: it goes to this app's own
